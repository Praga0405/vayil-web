...
// Enter any 10-digit mobile number to log in instantly
export default function CustomerLoginPage() {
  ...
  const login = () => {
    ...
    setTimeout(() => {
      ...
      setAuth(authUser, 'dev_customer_token_' + mobile)
    ...
    <div className="min-h-screen bg-gradient-to-br from-navy to-navy-700 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-navy-200 text-sm mt-2">Home Services Marketplace</p>
        </div>
        ...
        <div className="auth-card animate-slide-up">
          ...
          <h2 className="heading-lg mb-1">Customer Login</h2>
          <p className="body-sm mb-6">Enter your mobile number to continue</p>
          ...
          <div className="mt-6 pt-6 border-t border-[var(--border)] text-center">
            <p className="text-xs text-[var(--text-muted)] mb-3">Are you a service vendor?</p>
            <Link href="/vendor/login" className="btn btn-outline btn-sm">
              Vendor Login
            </Link>
          </div>
        </div>
