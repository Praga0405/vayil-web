...
export interface MockJob {
  ...
  paid: number
  pending: number
  plan_status: 'NOT_STARTED' | 'DRAFT' | 'SUBMITTED' | 'APPROVED' | 'REVISION_REQUESTED' | 'AWAITING_PAYMENT' | 'READY_TO_COMPLETE' | 'AWAITING_CUSTOMER_CLOSE' | 'AWAITING_RELEASE' | 'COMPLETED'
